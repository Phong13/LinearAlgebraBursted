...
namespace LinearAlgebra
{
    ...
    public static partial class fProxyOP {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void copyInpl<T>(this T place, T from) where T : unmanaged, IUnsafefProxyArray
        {
        ...
        /// Different from subInpl(this T v, fProxy s) which computes v = v - s.
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void rsubInpl<T>(this T v, fProxy s) where T : unmanaged, IUnsafefProxyArray
        {
            unsafe {
