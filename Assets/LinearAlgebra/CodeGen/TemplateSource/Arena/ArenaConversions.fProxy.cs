...
namespace LinearAlgebra
{
    ...
    public static partial class ArenaExtensions {
        ...
        public static double[,] ToDoubleArray(this fProxyMxN mathVec)
        {
            Arena.CheckValid(mathVec);
        ...
        public static float[,] ToFloatArray(this fProxyMxN mathVec)
        {
            Arena.CheckValid(mathVec);
        ...
        /// </summary>
        public static void FlattenColumnMajorInpl(this fProxyMxN srcMat, fProxyN toHereFlat)
        {
        ...
        public static void UnFlattenFromColumnMajorInpl(this fProxyN srcFlat, fProxyMxN toHere)
        {
        ...
        public static float[] ToFloatArray(this fProxyN mathVec)
        {
            Arena.CheckValid(mathVec);
        ...
        public static double[] ToDoubleArray(this fProxyN mathVec)
        {
            Arena.CheckValid(mathVec);
