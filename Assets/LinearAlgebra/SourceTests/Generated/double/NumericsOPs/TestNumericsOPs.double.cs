...
public class TestNumericsOPsdouble
{
    static void ToDotNetMatrix(doubleMxN m, out Matrix<double> mm)
    {
    ...
    static void ToDotNetVector(doubleN m, out Vector<double> mm)
    {
    ...
    static void DoLinAlgBurstedSVD(double[,] _A, out Vector<double> S, out Matrix<double> U, out Matrix<double> VT)
    {
        ...
        {
            doubleMxN A = arena.doubleMat(_A);
            ...
            var _tmp = doubleOP.dot(w, vt);
            var AA = doubleOP.dot(u, _tmp);
    ...
    static void DoLinAlgBurstedSVDSolve(double[,] _A, double[,] _b, out Matrix<double> x, double eps)
    {
        Arena arena = new Arena(Unity.Collections.Allocator.Persistent);
        {
            doubleMxN A = arena.doubleMat(_A);
            doubleMxN b = arena.doubleMat(_b);
    ...
    public void TestMulMatMat()
    {
        ...
        Arena arena = new Arena(Unity.Collections.Allocator.Persistent);
        {
            doubleMxN A = arena.doubleMat(_A);
            doubleMxN B = arena.doubleMat(_B);
            doubleMxN CCC = doubleOP.dot(A, B);
