...
public class floatCompareTests
{
    ...
    public struct TestsJob : IJob 
    {
        ...
        public void VecRandom(ref Arena arena)
        {
            ...
            floatN v = arena.floatRandomVector(dim, -1f, 1f, 1451, true);
        ...
        public void MatRandom(ref Arena arena)
        {
            ...
            floatMxN m = arena.floatRandomMatrix(dim, dim, -1f, 1f, 1451, true);
            // set first element to zero
            m[0,0] = 0f;
        ...
        public void MatDiagonal(ref Arena arena)
        {
            ...
            floatMxN m0 = arena.floatDiagonalMatrix(dim, 1f, true);
        ...
        public void VecVecEquals(ref Arena arena)
        {
            ...
            floatN v0 = arena.floatLinVector(dim, 0f, 1f, true);
            floatN v1 = arena.floatLinVector(dim, 0f, 1f, true);
        ...
        public void VecVecNotEquals(ref Arena arena)
        {
            ...
            floatN v0 = arena.floatLinVector(dim, 0f, 1f, true);
            floatN v1 = arena.floatLinVector(dim, 2f, 3f, true);
        ...
        public void VecVecLessOrEqual(ref Arena arena)
        {
            ...
            v0 = arena.floatLinVector(dim, 0f, 1f, true);
            v1 = arena.floatLinVector(dim, 1f, 0f, true);
        ...
        public void VecVecGreater(ref Arena arena)
        {
            ...
            v0 = arena.floatLinVector(dim, 1f, 0f, true);
            v1 = arena.floatLinVector(dim, 0f, 1f, true);
        ...
        public void VecVecRandom(ref Arena arena)
        {
            ...
            floatN v0 = arena.floatRandomVector(dim, -1f, 1f, 1451, true);
            floatN v1 = arena.floatRandomVector(dim, -1f, 1f, 6421, true);
        ...
        public void MatMatEquals(ref Arena arena)
        {
            ...
            floatMxN m0 = arena.floatRandomMatrix(dim, dim, 0f, 1f, 12343, true);
            floatMxN m1 = arena.floatRandomMatrix(dim, dim, 0f, 1f, 12343, true);
        ...
        public void MatMatNotEquals(ref Arena arena)
        {
            ...
            floatMxN m0 = arena.floatRandomMatrix(dim, dim, 0f, 1f, 2131, true);
            floatMxN m1 = arena.floatRandomMatrix(dim, dim, 0f, 1f, 2131, true);

            var boolMat = m0 != m1;
            Assert.IsTrue(BoolAnalysis.IsAllEqualTo(boolMat, false));

            m1 = arena.floatRandomMatrix(dim, dim, 2f, 3f, 2131, true);
        ...
        public void MatMatLess(ref Arena arena)
        {
            ...
            floatMxN m0 = arena.floatRandomMatrix(dim, dim, 0f, 1f, 2131, true);
            floatMxN m1 = arena.floatRandomMatrix(dim, dim, 2f, 3f, 2131, true);
        ...
        public void MatMatLessOrEqual(ref Arena arena)
        {
            ...
            m0 = arena.floatRandomMatrix(dim, dim, 1f, 0f, 2131, true);
            m1 = arena.floatRandomMatrix(dim, dim, 0f, 1f, 2131, true);
        ...
        public void MatMatRandom(ref Arena arena)
        {
            ...
            floatMxN m0 = arena.floatRandomMatrix(dim, dim, -1f, 1f, 1451, true);
            floatMxN m1 = arena.floatRandomMatrix(dim, dim, -1f, 1f, 6421, true);
