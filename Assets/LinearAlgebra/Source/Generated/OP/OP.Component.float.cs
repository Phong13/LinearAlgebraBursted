...
namespace LinearAlgebra
{
    ...
    public static partial class floatOP {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void copyInpl<T>(this T place, T from) where T : unmanaged, IUnsafefloatArray
        {
        ...
        /// Different from subInpl(this T v, float s) which computes v = v - s.
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void rsubInpl<T>(this T v, float s) where T : unmanaged, IUnsafefloatArray
        {
            unsafe {
