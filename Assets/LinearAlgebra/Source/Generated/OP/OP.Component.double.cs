...
namespace LinearAlgebra
{
    ...
    public static partial class doubleOP {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void addInpl<T>(this T place, double s) where T : unmanaged, IUnsafedoubleArray {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void mulInpl<T>(this T place, double s) where T : unmanaged, IUnsafedoubleArray
        {
            unsafe {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static doubleN Col(this doubleMxN a, int col, int rowStartIdx, bool isTemp)
        {
            Arena.CheckValid(a);
            unsafe
            {
