...
namespace LinearAlgebra
{
    ...
    public partial struct floatN : IDisposable, IUnsafefloatArray, IEquatable<floatN> {
        ...
        public unsafe floatN CopyPersistent()
        {
        ...
        /// </summary>
        public unsafe floatN CopyTemp()
        {
            return _arenaPtr->tempfloatVec(in this);
        }
        ...
        public unsafe floatN TempCopy() => CopyTemp();
        ...
        public unsafe bool Equals(floatN other)
        {
